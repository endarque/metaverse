$(document).ready(function () {
        ...
        if(!user['is_teacher']) {
            $('#div_studentCam').slick('slickAdd',
                '<div id="'+ user['socketId'] +'" style="padding:10px;display: flex;justify-content: center;flex-direction: column;flex-wrap: wrap;align-content: center;">' +
                    '<img src="static/images/avatar.jpg" width=160px; height=160px; style="border-radius:5px;color: #c6d3e7;">' +
    ...
    socket.on('connectionSuccess', function() {
        ...
        socket.emit('joinRoom', {'room': roomName, 'is_teacher': true })
    });
    ...
    $('#btn_camera').click(function () {
        ...
        var class_on = 'fas fa-eye';
        var class_off = 'fas fa-eye-slash';
    ...
    $('#btn_mic').click(function () {
        ...
        var class_on = 'fas fa-microphone';
        var class_off = 'fas fa-microphone-slash';
