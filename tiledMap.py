...
path_to_find = os.path.join(base_dir, 'MAAP_V1/venv/static/metaverse/asset/map')
...
for map_type in dir_list:
    ...
    if os.path.isdir(full_filepath) and len(map_type) < 5:
        ...
        for map_name in os.listdir(full_filepath):
            ...
            print(map_type, map_name, map_img_name, map_info_text_data, map_layer_num, map_width, map_height)
